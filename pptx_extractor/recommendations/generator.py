...
def generate_anthropic_recommendation(slide_data: Dict, api_key: str) -> str:
    """
    ...
    try:
        ...
        # Extract slide context and create prompt
...
def generate_google_recommendation(slide_data: Dict, api_key: str) -> str:
    """
...
def generate_recommendation(slide_data: Dict, api_key: str, provider: str = "anthropic") -> str:
    """
    ...
    """
    if provider == "google":
        return generate_google_recommendation(slide_data, api_key)
    else:
        return generate_anthropic_recommendation(slide_data, api_key)

def generate_all_recommendations(slides_data: Dict, api_key: str, provider: str = "anthropic") -> Dict:
    """
    ...
    for slide in slides_data.get('slides', []):
        ...
        recommendation = generate_recommendation(slide, api_key, provider)
