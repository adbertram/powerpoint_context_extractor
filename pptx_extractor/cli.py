#!/usr/bin/env python3
"""
Command-line interface for PowerPoint Context Extractor.
"""
...
from .notes.extractor import extract_slide_notes
from .animations.extractor import extract_slide_animations
from .slides.extractor import extract_slides
